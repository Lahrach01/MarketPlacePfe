...
Congratulations! Your shop is now ready.
';
	...
	public static function account( Event $event )
	{
		...
		if( $email && $passwd )
		{
			...
			$io->write( 'Create admin account manually' ); $options );
		}
		else
		{
	...
	public static function setup( Event $event )
	{
		...
		self::executeCommand( $event, 'migrate', $options );
	}
	 ...
	 * @param string $cmd Command name to execute, e.g. "migrate"
