...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Context for icon and logo in all Blade templates
        View::composer('*', function ( $view ) {
            try {
                $view->with( 'sitedata', null );
            } catch( \Exception $e ) {
                $view->with( 'sitedata', null );
            }
        });
        ...
        \App\Http\Controllers\ResolveController::register( 'cms', function( $context, $path ) {
